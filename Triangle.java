...
public class Triangle {
	...
	double area() {
		return (sideB().segmentLength() + new LineSegment(vertexB,
				new Point3DSpace(vertexA.getX_Coordinate() + sideB().dX() / 2.0,
						vertexA.getY_Coordinate() + sideB().dY() / 2.0, vertexA.getZ_Coordinate() + sideB().dZ() / 2.0))
								.segmentLength())
				/ 2.0;
	}
